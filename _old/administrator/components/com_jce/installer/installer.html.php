...
function writableCell( $folder ) {
	...
	echo '<td align="left">';
	echo is_writable( $GLOBALS['mosConfig_absolute_path'] . '/' . $folder ) ? '<b><font color="green">Beschreibbar</font></b>' : '<b><font color="red">Unbeschreibbar</font></b>' . '</td>';
	echo '</tr>';
}
	...
	*/
	function showInstallMessage( $message, $title, $url ) {
		...
		<tr>
			...
			[&nbsp;<a href="<?php echo $url;?>" style="font-size: 16px; font-weight: bold">Weiter ...</a>&nbsp;]
			</td>
		</tr>
		</table>
		<?php
