...
FCKConfig.ToolbarSets["Compact"] = [
	...
	['Link','Unlink','Anchor'],
	['Image','Flash','-','Table','Templates','Rule','Smiley','SpecialChar','PageBreak','UniversalKey']
] ;
...
// Modified by Franki Cheung 20060105
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=files&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
...
FCKConfig.LinkUploadURL = FCKConfig.BasePath + 'filemanager/upload/' + _QuickUploadLanguage + '/upload.' + _QuickUploadLanguage + '?Type=files' ;
FCKConfig.LinkUploadAllowedExtensions	= "" ;
FCKConfig.LinkUploadDeniedExtensions	= ".(php|php3|php5|phtml|asp|aspx|ascx|jsp|cfm|cfc|pl|bat|exe|dll|reg|cgi)$" ;

FCKConfig.ImageUpload = true ;
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/upload/' + _QuickUploadLanguage + '/upload.' + _QuickUploadLanguage + '?Type=images' ;
