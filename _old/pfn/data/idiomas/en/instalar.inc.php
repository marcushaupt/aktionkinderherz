...
return array(
	...
	'continuar_paso_2' => 'Continue to step 2 &raquo;',
	'continuar_paso_3' => 'Continue to step 3 &raquo;',
	'continuar_paso_4' => 'Continue to step 4 &raquo;',
	'continuar_paso_5' => 'Install &raquo;',
	'continuar_paso_6' => 'Finish &raquo;',
	'voltar_paso_1' => '&laquo; Back to step 1',
	'voltar_paso_2' => '&laquo; Back to step 2',
	'voltar_paso_3' => '&laquo; Back to step 3',
	...
	'i:safe_mode_ok' => 'The server&acute;s configuration is correct for safe_mode = Off.',
	...
	'i:erros' => array(
		...
		'15' => 'The indicated user hasn&acute;t got access to the database',
	...
	'i:crear_directorios_ok' => '<p>All the necessary directories were created correctly.</p><br /><p>It is possible that the user ID of the Web server does not have permissions to delete certain folders - in which case, the administrator will have to verify and eliminate them manually.</p><br /><p>The directories that must be deleted are <strong>tmp/data/info/</strong> and <strong>data/logs/</strong> (but does not need to delete any directory contained in data/servidor/).</p>',
