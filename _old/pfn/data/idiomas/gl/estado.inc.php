...
return array(
	...
	'estado.descargar' => array(
		...
		'3' => 'Non se puido abrir o arquivo de rexistro para gardar os datos da descarga. Por favor, revisa o directorio [*$this->paths["info"]*]',
	),
	...
	'estado.correo' => array(
		...
		'10' => 'Non se permite enviar este arquivo xa que supera o l&iacute;mite de [*PFN_peso($this->g("limite_correo"))*] para un adxunto.',
	),
);
?>