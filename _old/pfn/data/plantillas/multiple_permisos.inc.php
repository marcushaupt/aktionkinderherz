...
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo $conf->t('accion').' &raquo; '.$conf->t('multiple_permisos'); ?></h1></div>
	<div class="bloque_info">
		...
		<table class="tabla_info" summary="" style="text-align: center;">
			<tr>
				<th><?php echo $conf->t('escritura'); ?></th>
				<th><?php echo $conf->t('execucion'); ?></th>
				<th><?php echo $conf->t('lectura'); ?></th>
				<th>&nbsp;</th>
			</tr>
			<tr>
