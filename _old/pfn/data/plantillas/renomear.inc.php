...
?>
		...
		<table class="tabla_info" summary="">
			<tr>
				<th><label for="antigo"><?php echo $conf->t('orixinal'); ?>:</label></th>
				<td><?php echo $vars->get('cal'); ?></td>
			</tr>
			<tr>
				<th><label for="novo_nome"><?php echo $conf->t('novo'); ?>:</label></th>
				<td><input type="text" id="novo_nome" name="novo_nome" value="<?php echo htmlentities($vars->get('cal'), ENT_NOQUOTES, $conf->g('charset')); ?>" class="text" /></td>
			</tr>
			<tr>
				<th>&nbsp;</th>
				<td>
