...
<?php } ?>
		...
		<div id="XidOpcion1" class="XCapaOpcion"> 
			...
			<br /><div class="con_borde">
				<select name="lista_raices1" id="lista_raices1" onchange="enlace('<?php echo PFN_get_url(); ?>&amp;opc=1&amp;lista_raices='+this.value);">
					<?php
					$usuarios->init('raices_total');

					$total = $usuarios->get('total');
			...
			<table class="Xmenu" summary="">
				<tr>
					...
					<th><?php echo $conf->t('Xpath'); ?></th>
					<th class="centro"><?php echo $conf->t('Xestado'); ?></th>
				</tr>
				<?php
				$usuarios->init('raices_pax', $lista_raices, $paxinar);
				...
				<tr class="trarq<?php echo $on; ?>">
					...
					<td><?php echo $usuarios->get('path'); ?></td>
					<td class="centro">
				...
				<tr>
					<td colspan="2">&nbsp;</td>
					<td class="centro"><br /><input type="submit" value="<?php echo $conf->t('Xcambiar'); ?>" class="boton" /></td>
				</tr>
			</table>
		...
		<div id="XidOpcion2" class="XCapaOpcion"> 
			...
			<table class="Xmenu" summary="">
				<tr>
					<th><?php echo $conf->t('usuario'); ?></th>
					<th><?php echo $conf->t('Xnome'); ?></th>
					<th><?php echo $conf->t('correo'); ?></th>
					<th class="centro"><?php echo $conf->t('Xestado'); ?></th>
				</tr>
				<?php
				$usuarios->init('usuarios_pax', $lista_usuarios, $paxinar);
				...
				<tr class="trarq<?php echo $on; ?>">
					<td>
						<input type="hidden" name="antes[<?php echo $id; ?>]" value="<?php echo $usuarios->get('estado'); ?>" />
						<a href="usuarios/index.php?<?php echo PFN_cambia_url('id_usuario',$id,false); ?>"><?php echo $usuarios->get('usuario'); ?></a>
					</td>
					<td><?php echo $usuarios->get('nome'); ?></td>
					<td><?php echo $usuarios->get('email'); ?></td>
					<td class="centro">
		...
		<div id="XidOpcion3" class="XCapaOpcion"> 
			...
			<table class="Xmenu" summary="">
				...
				<?php
				$usuarios->init('grupos_pax', $lista_grupos, $paxinar);
		...
		<div id="XidOpcion4" class="XCapaOpcion"> 
			<table class="Xmenu" summary="">
				...
				<tr class="trarq<?php echo $on; ?>">
					...
					<td>
						<?php if (is_writable($PFN_paths['conf'].$usuarios->get('conf').'.inc.php')) { ?>
