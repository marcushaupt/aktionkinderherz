...
<div id="ver_info">
	...
	<div class="bloque_info">
		...
		<table class="tabla_info" summary="">
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(2); return false;">(?)</a> <label for="usuario"><?php echo $conf->t('Xusuario'); ?>*</label></th>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(3); return false;">(?)</a> <label for="contrasinal"><?php echo $conf->t('Xcontrasinal'); ?></label></th>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(4); return false;">(?)</a> <label for="rep_contrasinal"><?php echo $conf->t('Xrep_contrasinal'); ?></label></th>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(5); return false;">(?)</a> <label for="email"><?php echo $conf->t('Xemail'); ?></label></th>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(6); return false;">(?)</a> <label for="max_descargas"><?php echo $conf->t('Xmax_descargas_mes'); ?></label></th>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(7); return false;">(?)</a> <label for="actual_descargas"><?php echo $conf->t('descargado_mes'); ?></label></th>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(11); return false;">(?)</a> <label for="cambiar_datos"><?php echo $conf->t('Xcambiar_datos'); ?></label></th>
				<td>
					<select id="cambiar_datos" name="cambiar_datos" tabindex="75">
						<option value="1" <?php echo $usuarios->get('cambiar_datos')==1?'selected="selected"':''; ?>>ON</option>
						<option value="0" <?php echo $usuarios->get('cambiar_datos')==0?'selected="selected"':''; ?>>OFF</option>
					</select>
				</td>
			</tr>
			<tr id="tr_axuda11" style="display: none;">
				<td colspan="2"><?php echo $conf->t('Xaxuda','cambiar_datos'); ?></td>
			</tr>
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(8); return false;">(?)</a> <label for="id_grupo"><?php echo $conf->t('Xgrupo'); ?>*</label></th>
				<td>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(9); return false;">(?)</a> <label for="admin"><?php echo $conf->t('Xadministrador'); ?></label></th>
				<td>
			...
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(10); return false;">(?)</a> <label for="estado"><?php echo $conf->t('Xestado'); ?></label></th>
				<td>
		...
		<table class="tabla_info" summary=""><tr><th><strong><?php echo $conf->t('Xraices_relacionadas'); ?></strong></th></tr></table>
