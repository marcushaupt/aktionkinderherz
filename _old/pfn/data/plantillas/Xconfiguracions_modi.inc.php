...
?>
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo $conf->t('xestion').' &raquo; '.$conf->t('Xconf_editar'); ?></h1></div>
	<div class="bloque_info">
		...
		<div class="aviso">
			...
			<?php echo $conf->t('Xcol_erro'); ?>:
			<br /><?php echo $alertas['erro']; ?>
			<hr style="border: 1px solid #F00; margin: 5px 0 5px 0;" />
			<?php echo $conf->t('Xcol_linha'); ?>:
		...
		<div style="width: 100%; text-align: center;">
			<h2><?php echo $usuarios->get('conf'); ?></h2>
			...
			<textarea name="texto" style="width: 100%; height: 400px;"><?php echo htmlentities($texto, ENT_NOQUOTES, $conf->g('charset')); ?></textarea>
			<br /><br /><input type="reset" value=" <?php echo $conf->t('cancelar'); ?> " class="boton" onclick="enlace('index.php?<?php echo PFN_cambia_url('id_conf', $id_conf, false); ?>');" />
			<input type="submit" value=" <?php echo $conf->t('aceptar'); ?> " style="margin-left: 40px;" class="boton" />
			</fieldset>
			</form>
		</div>
	</div>
