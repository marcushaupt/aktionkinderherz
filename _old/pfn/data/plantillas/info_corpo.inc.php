...
?>
		...
		<div class="bloque_info">
			...
			<table class="tabla_info" summary="">
				<tr>
					<th><?php echo $conf->t('tamano_real'); ?></th>
					<td><?php echo $tamano_real; ?></td>
					<th><?php echo $conf->t('propietario'); ?></th>
					<td><?php echo $datos['uid']; ?></td>
				</tr>
				<tr>
					<th><?php echo $conf->t('tamano_disco'); ?></th>
					<td><?php echo $tamano_disco; ?></td>
					<th><?php echo $conf->t('grupo'); ?></th>
					<td><?php echo $datos['gid']; ?></td>
				</tr>
				<tr>
					<th><?php echo $conf->t('ultima_modificacion'); ?></th>
					<td><?php echo date($conf->g('data'), $datos['mtime']); ?></td>
					<th><?php echo $conf->t('permisos'); ?></th>
					<td><?php echo $permisos; ?></td>
				</tr>
				<?php if ($e_imaxe) { ?>
				<tr>
					<th><?php echo $conf->t('ancho_imaxe'); ?></th>
					<td><?php echo $e_imaxe[0]; ?>px</td>
					<th><?php echo $conf->t('alto_imaxe'); ?></th>
		...
		<div class="bloque_info">
			...
			<table class="tabla_info" summary="">
				<tr>
					<th><?php echo $conf->t('absoluto'); ?></th>
					<td><?php echo $enlace_abs; ?></td>
				</tr>
				<tr>
					<th><?php echo $conf->t('relativo'); ?></th>
					<td><?php echo $enlace_rel; ?></td>
				</tr>
				<tr>
					<th><?php echo $conf->t('ahref'); ?></th>
					<td><?php echo $enlace_href; ?></td>
				</tr>
				<tr>
					<th><?php echo $conf->t('phpwiki'); ?></th>
					<td><?php echo $enlace_phpwiki; ?></td>
				</tr>
				<tr>
					<th><?php echo $conf->t('mediawiki'); ?></th>
		...
		<div class="bloque_info">
			...
			<table class="tabla_info" summary="">
				...
				<tr>
					<th><?php echo $conf->t('contrasinal'); ?></th>
