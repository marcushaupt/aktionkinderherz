...
?>
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo $conf->t('xestion').' &raquo; '.$conf->t('Xinformes'); ?></h1></div>
			...
			<table class="tabla_info" summary="">
				<tr>
					<th style="text-align: center;">
						<a href="#" onclick="opc = 'mysql'; oculta('capa_accions','capa_accesos','capa_uso_disco','capa_ancho_banda'); amosa('capa_mysql');"><?php echo $conf->t('Xtit_mysql'); ?></a>
						&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="#" onclick="opc = 'accions'; oculta('capa_mysql','capa_accesos','capa_uso_disco','capa_ancho_banda'); amosa('capa_accions');"><?php echo $conf->t('Xtit_accions'); ?></a>
						&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="#" onclick="opc = 'accesos'; oculta('capa_mysql','capa_accions','capa_uso_disco','capa_ancho_banda'); amosa('capa_accesos');"><?php echo $conf->t('Xtit_accesos'); ?></a>
						&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="#" onclick="opc = 'uso_disco'; oculta('capa_mysql','capa_accions','capa_accesos','capa_ancho_banda'); amosa('capa_uso_disco');"><?php echo $conf->t('Xtit_uso_disco'); ?></a>
						&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="#" onclick="opc = 'ancho_banda'; oculta('capa_mysql','capa_accions','capa_accesos','capa_uso_disco'); amosa('capa_ancho_banda');"><?php echo $conf->t('Xtit_ancho_banda'); ?></a>
					</th>
				</tr>
			</table>
