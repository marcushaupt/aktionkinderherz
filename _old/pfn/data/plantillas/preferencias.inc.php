...
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo $conf->t('preferencias_usuario'); ?></h1></div>
	<div class="bloque_info">
		...
		<table class="tabla_info" summary="">
			<tr>
				<th><label for="preferencias_nome"><?php echo $conf->t('nome'); ?>:</label></th>
				<td><input type="text" name="preferencias_nome" id="preferencias_nome" class="text" value="<?php echo $usuarios->get('nome'); ?>" /></td>
			</tr>
			<tr>
				<th><label for="preferencias_email"><?php echo $conf->t('correo'); ?>:</label></th>
				<td><input type="text" name="preferencias_email" id="preferencias_email" class="text" value="<?php echo $usuarios->get('email'); ?>" /></td>
			</tr>
			<tr>
				<th><label for="preferencias_contrasinal"><?php echo $conf->t('contrasinal'); ?>:</label></th>
				<td><input type="password" name="preferencias_contrasinal" id="preferencias_contrasinal" class="text" value="" /></td>
			</tr>
			<tr>
				<th><label for="preferencias_contrasinal_rep"><?php echo $conf->t('contrasinal_rep'); ?>:</label></th>
