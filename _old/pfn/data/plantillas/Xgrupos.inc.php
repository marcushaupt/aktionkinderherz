...
<div id="ver_info">
	...
	<div class="bloque_info">
		...
		<table class="tabla_info" summary="">
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(1); return false;">(?)</a> <?php echo $conf->t('Xnome'); ?>*</th>
			...
			<tr id="tr_axuda1" style="display: none;">
				<th colspan="2"><?php echo $conf->t('Xaxuda','grupo_nome'); ?></th>
			</tr>
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(2); return false;">(?)</a> <?php echo $conf->t('Xconf_defecto'); ?>*</th>
				<td>
			...
			<tr id="tr_axuda2" style="display: none;">
				<th colspan="2"><?php echo $conf->t('Xaxuda','grupo_conf'); ?></th>
			</tr>
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(3); return false;">(?)</a> <?php echo $conf->t('Xestado'); ?></th>
				<td>
			...
			<tr id="tr_axuda3" style="display: none;">
				<th colspan="2"><?php echo $conf->t('Xaxuda','grupo_estado'); ?></th>
			</tr>
			<tr>
				<th><a href="#" onclick="Xamosa_axuda(4); return false;">(?)</a> <label for="revisar_relacions_raices"><?php echo $conf->t('Xrevisar_relacions_raices'); ?></label></th>
			...
			<tr id="tr_axuda4" style="display: none;">
				<td colspan="2"><?php echo $conf->t('Xaxuda','revisar_relacions_raices'); ?></td>
			</tr>
		</table>

		<br />
		<?php if (!empty($id_grupo)) { ?>
		<table class="tabla_info" summary=""><tr><th><strong><?php echo $conf->t('Xusuarios_relacionados'); ?></strong></th></tr></table>
