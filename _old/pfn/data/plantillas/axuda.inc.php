...
<div class="bloque_info">
	...
	<div style="margin-left: 10px;">
		...
		<div id="quero_crear_dir" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_crear_dir'), $conf->g('estilo')); ?></div>
		<br /><a href="#" onclick="amosa_axuda('quero_subir_arq'); return false;"><?php echo $conf->t('tit_subir_arq'); ?></a>
		<div id="quero_subir_arq" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_subir_arq'), $conf->g('estilo')); ?></div>
		<br /><a href="#" onclick="amosa_axuda('quero_subir_url'); return false;"><?php echo $conf->t('tit_subir_url'); ?></a>
		<div id="quero_subir_url" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_subir_url'), $conf->g('estilo')); ?></div>
		<br /><a href="#" onclick="amosa_axuda('quero_miniaturas'); return false;"><?php echo $conf->t('tit_miniaturas'); ?></a>
		<div id="quero_miniaturas" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_miniaturas'), $conf->g('estilo')); ?></div>
		<br /><a href="#" onclick="amosa_axuda('quero_arbore'); return false;"><?php echo $conf->t('tit_arbore'); ?></a>
		<div id="quero_arbore" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_arbore'), $conf->g('estilo')); ?></div>
	...
	<div style="margin-left: 10px;">
		...
		<div id="problema_miniaturas" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_problema_miniaturas'), $conf->g('estilo')); ?></div>
		<br /><a href="#" onclick="amosa_axuda('problema_paxinar'); return false;"><?php echo $conf->t('tit_problema_paxinar'); ?></a>
		<div id="problema_paxinar" style="background-color: #EEE; display: none; padding: 5px;"><?php echo $conf->t(array('txt_problema_paxinar'), $conf->g('paxinar')); ?></div>
	...
	<div style="margin-left: 10px;">
		<table class="tabla_info" summary="">
			...
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/info.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_info'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','copiar')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/copiar.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_copiar'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','mover')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/mover.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_mover'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','renomear')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/renomear.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_renomear'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','eliminar')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/eliminar.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_eliminar'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','permisos')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/permisos.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_permisos'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','descargar')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/descargar.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_descargar'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','descargar') && $conf->g('permisos','comprimir')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/comprimir.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_comprimir'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','redimensionar')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/redimensionar.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_redimensionar'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','extraer')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/extraer.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_extraer'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','ver_contido')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/ver_contido.png') 50% -19px no-repeat; margin: 3px;"></div></th>
				<td><?php echo $conf->t('txt_ver_contido'); ?></td>
			</tr>
			<?php } if ($conf->g('permisos','editar')) { ?>
			<tr>
				<th><div style="width: 22px; height: 17px; background: url('<?php echo $conf->g('estilo'); ?>imx/editar.png') 50% -19px no-repeat; margin: 3px;"></div></th>
