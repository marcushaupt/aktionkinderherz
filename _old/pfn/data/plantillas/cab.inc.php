...
<meta http-equiv="Content-Type" content="text/html; charset=<?php echo $conf->g('charset'); ?>" />
...
<?php if (strstr($vars->server('PHP_SELF'), 'xestion')) { ?>
<link rel="stylesheet" href="<?php echo $relativo.$conf->g('estilo'); ?>xestion.css" type="text/css" />
<?php } ?>
...
imaxes[1].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/fondo.png";
imaxes[2].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/info.png";
imaxes[3].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/copiar.png";
imaxes[4].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/mover.png";
imaxes[5].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/eliminar.png";
imaxes[6].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/renomear.png";
imaxes[7].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/permisos.png";
imaxes[8].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/descargar.png";
imaxes[9].src = "<?php echo $relativo.$conf->g('estilo'); ?>imx/comprimir.png";
