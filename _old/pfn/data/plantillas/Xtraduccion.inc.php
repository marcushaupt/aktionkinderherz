...
?>
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo $conf->t('xestion').' &raquo; '.$conf->t('Xtraduccion'); ?></h1></div>
	<div class="bloque_info">
		<div id="Xinformes_cab">
			<div style="background: #EEE; text-align: center;"><a href="estado.php?<?php echo PFN_get_url(false); ?>"><?php echo $conf->t('Xcomprobar_traduccions'); ?></a></div>

			<br /><?php echo $conf->t('Xtraduccion_intro'); ?><br />
			...
			<br /><div style="text-align: center;">
				<strong><?php echo $conf->t('charset'); ?>:</strong>
				...
				<strong><?php echo $conf->t('Xlistar'); ?>:</strong>
				<select name="tr_listar">
					<option value="todas"<?php echo ($tr_listar == 'todas')?' selected="selected"':''; ?>> <?php echo $conf->t('Xtodas'); ?></option>
					<option value="vacias"<?php echo ($tr_listar == 'vacias')?' selected="selected"':''; ?>> <?php echo $conf->t('Xsen_traducir'); ?></option>
				</select>

				<br />

				<strong><?php echo $conf->t('Xarquivo'); ?>:</strong>
				...
				<strong><?php echo $conf->t('orixe'); ?>:</strong>
				<select name="tr_orixe">
					<option value=""><?php echo $conf->t('Xescolle_idioma'); ?></option>
					<?php
				...
				<strong><?php echo $conf->t('destino'); ?>:</strong>
				...
				<br /><br />
				<input type="reset" value=" <?php echo $conf->t('voltar'); ?> " class="boton" onclick="enlace('../index.php?<?php echo PFN_get_url(false); ?>');" />
				<input type="submit" value=" <?php echo $conf->t('aceptar'); ?> " style="margin-left: 40px;" class="boton" /><br />
			</div><br />
			</fieldset>
			</form>
		</div>
		...
		<div id="Xinformes_resultado">
			...
			<div style="text-align: center;">
				<input type="reset" value=" <?php echo $conf->t('Xreiniciar_campos'); ?> " class="boton" />
				<input type="submit" value=" <?php echo $conf->t('Xgardar_idioma'); ?> " style="margin-left: 40px;" class="boton" />
			</div>
			<?php } ?>
			<br /><br />
			</fieldset>
