...
<h1 id="benvido"><?php echo $conf->t('novo_contrasinal'); ?></h1>
...
<div id="login">
	...
	<p><label for="activar_usuario"><?php echo $conf->t('usuario'); ?>:</label>
	<br /><input type="text" id="activar_usuario" name="activar_usuario" class="formulario" /></p>
	<p><label for="activar_contrasinal"><?php echo $conf->t('novo_contrasinal'); ?>:</label>
...
<?php } ?>
<p id="login_olvido_contrasinal"><a href="index.php"><?php echo $conf->t('voltar'); ?></a></p>
