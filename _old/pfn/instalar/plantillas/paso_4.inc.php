...
function comproba_datos (obx_form) {
	...
	if (obx_form.charset.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',1)); ?>';
		campo = 'charset';
	} else if (obx_form.db_servidor.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',2)); ?>';
		campo = 'db_servidor';
	} else if (obx_form.db_nome.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',3)); ?>';
		campo = 'db_nome';
	} else if (obx_form.db_usuario.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',4)); ?>';
		campo = 'db_usuario';
	} else if (obx_form.ad_nome.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',5)); ?>';
		campo = 'ad_nome';
	} else if (obx_form.ad_usuario.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',6)); ?>';
		campo = 'ad_usuario';
	} else if (obx_form.ad_contrasinal.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',7)); ?>';
		campo = 'ad_contrasinal';
	} else if (obx_form.ad_contrasinal.value != obx_form.ad_rep_contrasinal.value) {
		erro = '<?php echo addslashes($conf->t('i:erros',8)); ?>';
		campo = 'ad_rep_contrasinal';
	} else if (obx_form.ad_correo.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',9)); ?>';
		campo = 'ad_correo';
	} else if (obx_form.ra_nome.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',10)); ?>';
		campo = 'ra_nome';
	} else if (obx_form.ra_path.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',11)); ?>';
		campo = 'ra_path';
	} else if (obx_form.ra_web.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',12)); ?>';
		campo = 'ra_web';
	} else if (obx_form.ra_dominio.value == '') {
		erro = '<?php echo addslashes($conf->t('i:erros',13)); ?>';
		campo = 'ra_dominio';
	}
...
<h2><?php echo $conf->t('i:datos'); ?></h2>

<br /><?php echo $conf->t('i:intro_datos'); ?><br />

<?php if (count($erros) > 0) { ?>
<ul class="aviso">
	<?php foreach ($erros as $v) { ?>
	<li>- <?php echo $conf->t('i:erros',$v); ?></li>
	<?php } ?>
</ul>
<?php } ?>
...
<table class="tabla_info" summary="">
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(1); return false;">(?)</a> <label for="form_charset"><?php echo $conf->t('i:charset'); ?></label>:</th>
		<td>
	...
	<tr id="tr_axuda1" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','charset'); ?></td>
	</tr>
	<tr>
		<td colspan="2"><br /><h1><?php echo $conf->t('i:base_datos'); ?></h1></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(2); return false;">(?)</a> <label for="form_db_servidor"><?php echo $conf->t('i:db_servidor'); ?></label>:</th>
	...
	<tr id="tr_axuda2" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','db_servidor'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(3); return false;">(?)</a> <label for="form_db_nome"><?php echo $conf->t('i:db_nome'); ?></label>:</th>
	...
	<tr id="tr_axuda3" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','db_nome'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(4); return false;">(?)</a> <label for="form_db_usuario"><?php echo $conf->t('i:db_usuario'); ?></label>:</th>
	...
	<tr id="tr_axuda4" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','db_usuario'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(5); return false;">(?)</a> <label for="form_db_contrasinal"><?php echo $conf->t('i:db_contrasinal'); ?></label>:</th>
	...
	<tr id="tr_axuda5" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','db_contrasinal'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(6); return false;">(?)</a> <label for="form_db_prefixo"><?php echo $conf->t('i:db_prefixo'); ?></label>:</th>
	...
	<tr id="tr_axuda6" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','db_prefixo'); ?></td>
	</tr>
	<tr>
		<td colspan="2"><br /><h1><?php echo $conf->t('i:administrador'); ?></h1></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(7); return false;">(?)</a> <label for="form_ad_nome"><?php echo $conf->t('i:ad_nome'); ?></label>:</th>
	...
	<tr id="tr_axuda7" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ad_nome'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(8); return false;">(?)</a> <label for="form_ad_usuario"><?php echo $conf->t('i:ad_usuario'); ?></label>:</th>
	...
	<tr id="tr_axuda8" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ad_usuario'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(9); return false;">(?)</a> <label for="form_ad_contrasinal"><?php echo $conf->t('i:ad_contrasinal'); ?></label>:</th>
	...
	<tr id="tr_axuda9" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ad_contrasinal'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(10); return false;">(?)</a> <label for="form_ad_rep_contrasinal"><?php echo $conf->t('i:ad_rep_contrasinal'); ?></label>:</th>
	...
	<tr id="tr_axuda10" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ad_rep_contrasinal'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(11); return false;">(?)</a> <label for="form_ad_correo"><?php echo $conf->t('i:ad_correo'); ?></label>:</th>
	...
	<tr id="tr_axuda11" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ad_correo'); ?></td>
	</tr>
	<tr>
		<td colspan="2"><br /><h1><?php echo $conf->t('i:raiz'); ?></h1></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(12); return false;">(?)</a> <label for="form_ra_nome"><?php echo $conf->t('i:ra_nome'); ?></label>:</th>
	...
	<tr id="tr_axuda12" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ra_nome'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(13); return false;">(?)</a> <label for="form_ra_path"><?php echo $conf->t('i:ra_path'); ?></label>:</th>
	...
	<tr id="tr_axuda13" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ra_path'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(14); return false;">(?)</a> <label for="form_ra_web"><?php echo $conf->t('i:ra_web'); ?></label>:</th>
	...
	<tr id="tr_axuda14" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ra_web'); ?></td>
	</tr>
	<tr>
		<th><a href="#" onclick="Xamosa_axuda(15); return false;">(?)</a> <label for="form_ra_dominio"><?php echo $conf->t('i:ra_dominio'); ?></label>:</th>
	...
	<tr id="tr_axuda15" style="display: none;">
		<td colspan="2"><?php echo $conf->t('i:axuda','ra_dominio'); ?></td>
	</tr>
</table>

<br />

<input type="submit" value="<?php echo $conf->t('continuar_paso_5'); ?>" class="dereita" />
</fieldset>
</form>
...
<input type="submit" value="<?php echo $conf->t('voltar_paso_3'); ?>" class="esquerda" />
</fieldset>
</form>
