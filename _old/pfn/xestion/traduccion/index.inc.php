...
if ($executa == 'escoller') {
	$idioma_orixe = $PFN_paths['idiomas'].$niveles->path_correcto($tr_orixe).'/'.$niveles->nome_correcto($tr_arquivo).'.inc.php';
	$path_destino = $PFN_paths['idiomas'].$niveles->path_correcto($tr_destino);
	...
	if (is_file($idioma_destino) && !is_writable($idioma_destino)) {
		...
		if (is_file($idioma_orixe)) {
			...
			$idioma_destino = $PFN_paths['idiomas'].$niveles->path_correcto($tr_destino).'/'.$niveles->nome_correcto($tr_arquivo).'.inc.php';
