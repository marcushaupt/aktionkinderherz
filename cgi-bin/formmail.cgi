...
@referers = ($domaincfg, "www.$domaincfg");
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        else                  { print "<title>Thank You / Vielen Dank </title>\n"        }
        ...
        else { print "<h1>Vielen Dank, dass Sie dieses Formular ausgef&uuml;llt haben.</h1>\n" }

        print "</center>\n";

        print "Folgenden Daten wurden am $date von Ihnen an $safeConfig{'recipient'} &uuml;bermittelt:";
...
sub send_mail {
    ...
    print MAIL "Folgende Anfrage wurde am $date &uuml;bermittelt von\n";
...
<html>
 <head>
  <title>Bad Referrer - Access Denied / Falsche Referenz - Zugriff verweigert  </title>
 </head>
 <body bgcolor=#FFFFFF text=#000000>
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>Bad Referrer - Access Denied /  Falsche Referenz - Zugriff verweigert  </font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td><a href="http://www.worldwidemart.com/scripts/formmail.shtml">FormMail</a>
     wurde von <tt>$referer</tt> aufgerufen, was nicht zul&auml;ssig ist. <p>
     Siehe dazu die <a href="http://www.worldwidemart.com/scripts/readme/formmail.shtml">README</a>
     Datei zu FormMail. Dort finden Sie auch eine genaue Anleitung zur Konfiguration von FormMail.<p>
     <hr size=1>
     <center><font size=-1>
...
<html>
 <head>
  <title>Error: Request Method / Unerlaubte Zugriffsmethode </title>
 </head>
 <body bgcolor=#FFFFFF text=#000000>
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>Error: Request Method / Unerlaubte Zugriffsmethode </font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td>Die von Ihnen verwendete Zugriffsmethode ist weder <tt>GET</tt> noch <tt>POST</tt>.
    Bitte &uuml;berpr&uuml;fen Sie Ihr Formular und stellen Sie sicher, dass das
    <tt>method=</tt> Statement <tt>GET</tt> oder <tt>POST</tt> lautet und gro&szlig;geschrieben ist.<p>
     <center><font size=-1>
...
<html>
 <head>
  <title>Error: Bad/No Recipient / Fehler: Fehlender oder ung&uuml;ltiger Empf&auml;nger</title>
 </head>
 <body bgcolor=#FFFFFF text=#000000>
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>
      Error: Bad/No Recipient / Fehler: Fehlender oder ung&uuml;ltiger Empf&auml;nger </font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td>Es wurde im Formular keine oder eine ung&uuml;ltige Empfangsadresse angegeben. Bitte
     stellen Sie sicher, dass Sie im <tt>recipient</tt> Formular-Feld eine E-Mail-Adresse angegeben
     haben, die im Array <tt>\@recipients</tt> eingetragen ist. Weitere Informationen zum F&uuml;llen des
     <tt>recipient</tt> Formular-Feldes finden Sie in der FormMail 
     <a href="http://www.worldwidemart.com/scripts/readme/formmail.shtml">README</a> Datei.<hr size=1>
     <center><font size=-1>
      <a href="http://www.scriptarchive.com/formmail.html">FormMail</a> V1.93 &copy; 1995 - 2009  Matt Wright<br>
      A Free Product of <a href="http://www.scriptarchive.com/">Matt's Script Archive, Inc.</a>
     </font></center>
...
<html>
 <head>
  <title>Error: Bad Header Fields / Ung&uuml;ltige Felder im Header </title>
 </head>
 <body bgcolor=#FFFFFF text=#000000>
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>Error: Bad Header Fields / Ung&uuml;ltige Felder im Header </font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td>Die Header-Felder <tt>recipient</tt>, <tt>email</tt>, <tt>realname</tt> and <tt>subject</tt> 
    wurden mit ung&uuml;ltigen Werten gef&uuml;llt. Diese d&uuml;rfen keine Zeilenumbr&uuml;che enthalten.
     Weitere Informationen zum F&uuml;llen der Formular-Felder finden Sie in der FormMail 
     <a href="http://www.worldwidemart.com/scripts/readme/formmail.shtml">README</a> Datei. <hr size=1>
     <center><font size=-1>
      <a href="http://www.scriptarchive.com/formmail.html">FormMail</a> V1.93 &copy; 1995 - 2009  Matt Wright<br>
      A Free Product of <a href="http://www.scriptarchive.com/">Matt's Script Archive, Inc.</a>
...
<html>
 <head>
  <title>Error: Blank Fields / Fehler: Leere Felder </title>
 </head>
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>Error: Blank Fields / Fehler: Leere Felder </font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td>Folgender Felder wurden im Formular nicht gef&uuml;llt:<p>
     <ul>
     $missing_field_list
     </ul><br>
     Diese Felder m&uuml;ssen gef&uuml;llt sein, um das Formular erfolgreich verarbeiten zu k&ouml;nnen.<p>
     Bitte benutzen Sie den Zur&uuml;ck-Knopf ihres Browsers, um zum Formular zur&uuml;ckzukehren und es noch
     einmal zu versuchen. <hr size=1>
     <center><font size=-1>
      <a href="http://www.scriptarchive.com/formmail.html">FormMail</a> V1.93 &copy; 1995 - 2009  Matt Wright<br>
      A Free Product of <a href="http://www.scriptarchive.com/">Matt's Script Archive, Inc.</a>
     </font></center>
